...
class TestStatuteSummarizer(unittest.TestCase):
    def test_summary(self):
        ...
        with open(test_html_path, "r", encoding="utf-8") as f:
            html = f.read()
            example_statute = StatuteParser.from_html(html)
        ...
        summary_no_context = summarizer.summarize(example_statute, "My client is in breach of contract for not fully paying for an order of Rearden Steel.", verbose=True)
